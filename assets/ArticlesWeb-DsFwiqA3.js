import{j as e,h as t}from"./index-wjD_FM3g.js";import{A as s}from"./ArticleList-BIp3k0cH.js";const S=()=>{const o=[{question:"浏览器从输入 URL 到页面展示详细过程",answer:`
...
`},{question:"浏览器中的 Cookie、localStorage 和 sessionStorage ",answer:`
## 浏览器中的 Cookie、localStorage、sessionStorage 全面解析
...
| 典型应用场景      | 登录凭证、身份认证（服务端使用） | 本地缓存，如主题色、设置 | 单页临时状态，如 tabIndex |
...
### 🧠 localStorage 和 sessionStorage 区别总结
...
- **Cookie 是客户端技术**，用来存 token / session id。
- **Session 是服务端机制**，保存用户登录状态、购物车等。
- Cookie 可保存一个 \`session_id\`，服务端通过它识别用户。
...
---
`}];return e.jsx(e.Fragment,{children:e.jsx("div",{children:e.jsx(s,{data:o,centerTitle:"Web",icon:e.jsx(t,{color:"#F7DF1E"})})})})};export{S as default};
