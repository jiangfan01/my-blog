import{j as e,c as o}from"./index-D-h_P2F3.js";import{A as s}from"./ArticleList-BXxd2fZv.js";const a=()=>{const t=[{question:"JS中的数据类型",answer:`
# 📚 JavaScript 中的数据类型
...
`},{question:"JavaScript 构造函数与 new 操作",answer:`
...
`},{question:"Promise、A+规范、方法、async/await",answer:`
...
`},{question:"ES6新增的 Set 和 Map",answer:`
...
`},{question:"ES6 剩余参数（rest 参数）",answer:`
...
`}];return e.jsx(e.Fragment,{children:e.jsx("div",{children:e.jsx(s,{data:t,centerTitle:"JavaScript",icon:e.jsx(o,{color:"#F7DF1E"})})})})};export{a as default};
