...
const ArticlesNode: React.FC = () => {
    const nodeArticles = [
        {
            question: "Node.js 的 FS（文件系统）模块使用",
            answer: `
...
`
        ...
        {
            question: "Node.js 的 http / https 模块讲解",
            answer: `
...
`
        ...
        {
            question: "Node.js 的 crypto 模块详解",
            answer: `
...
`
        ...
        {
            question: "Node.js 中的 JWT（JSON Web Token）使用",
            answer: `
...
`
        ...
        {
            question: "除了 Express，Node 还有哪些优秀框架？",
            answer: `
## 🚀 Node.js 常见开发框架盘点
...
`
        ...
        {
            question: "Node.js 中的 ORM（对象关系映射）",
            answer: `
## 🧩 什么是 ORM？
...
`
    ...
    return (
        <>
            <div>
                <ArticleList data={nodeArticles} centerTitle="Node.js" icon={<FaNodeJs color="#8CC084"/>}/>
            </div>
        </>
    );
}

export default ArticlesNode;